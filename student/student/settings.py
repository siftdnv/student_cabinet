...
SECRET_KEY = 'django-insecure-1eu&bkc2g2&($@e(rx(*np!88+s2@zhz+=0bu-&et(hvu%2luk'
...
# Добавьте эти настройки для статических файлов
STATICFILES_DIRS = [
...
# Сообщения (опционально, для красивого отображения)
